...
const { analyzeCareer,analyzeHealth,analyzeEducation,analyzeFinance,analyzeMatching,analyzeMentalHealth,analyzeKundli,analyzeAstrology,analyzeLove } = require("../controllers/aiFearuteController");
...
router.post("/analyze-kundli", analyzeKundli );
